...
CREATE TABLE `orders` (
    ...
    `status` ENUM('pending', 'accepted', 'rejected', 'partially_accepted', 'preparing', 'shipping', 'delivered') NOT NULL DEFAULT 'pending',
...
CREATE TABLE `order_items` (
    ...
    `status` ENUM('pending', 'accepted', 'rejected', 'preparing', 'shipping', 'delivered') NOT NULL DEFAULT 'pending',
    `created_at` TIMESTAMP NULL DEFAULT NULL,
    `updated_at` TIMESTAMP NULL DEFAULT NULL,
    PRIMARY KEY (`id`),
